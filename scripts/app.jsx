      ...
      <div>
        ...
        <div className="Todo">
          <div className="Todo__inputs">
            ...
            <input
              type="text"
              className="Todo__inputs__descriptions"
          ...
          <div className="Todo__itemList">
            <ul className="Todo__itemList__list">
              {this.props.todos.map(todo =>
                <li>
                  <span className="Todo__itemList__item__name">{todo.get('name')}</span>
                  <span className="Todo__itemList__item__description">{todo.get('description')}</span>
                </li>
              )}
            </ul>
          </div>
